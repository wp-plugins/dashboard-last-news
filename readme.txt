...
Allows you to display the last items of several feeds in your dashboard 
	...
	+++ For each widget, aggegates as much feeds as you like (5 to 20) and display the last items (5 to 20).
...
###FIRST ! & IMPORTANT STUFF !###
	...
	1 - **create** the folder cache under wp-content, **make sure it is writeable**.
		This should result in the following file structure:

		`- wp-content
		    - cache`

	2 - **plugin** : (unless you are already using SimplePie class) [SimplePie core](http://simplepie.org/wiki/plugins/wordpress/simplepie_core)
...
= How long the feeds are cached ? =
	...
	> 1 - SimplePie default is 1 hour (3600 seconds).
	> 2 - NOT RECOMMENDED : but if you want to change this, 
	...
	> 3 - [More about SimplePie caching system](http://simplepie.org/wiki/faq/how_does_simplepie_s_caching_http_conditional_get_system_work)
