 ...
 * Settings
	1 set the title, 
	2 display images if available (y/n), 
	3 set the number of url feeds (need to save them and re edit the widget if you need more space),
	4 set the number of lines 
	5 fill your url feeds in the widget control panel.
...
= How long the feeds are cached ? =
	...
	* NOT RECOMMENDED : but if you want to change this, 
		...
		3 and you might see what you have to do ...
